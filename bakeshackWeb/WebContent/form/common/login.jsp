...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack016.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
		<div class="d-flex flex-column flex-root">
			<!--begin::Login-->
			<div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack016.jpg);">
				<div class ="p-3 mb-2 bg-transparent text-dark " >
					<div class="login-form text-center text-black p-7 position-relative overflow-hidden ">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/Bake-Shack-Logo.png" class="max-h-100px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
...
<!-- 									<a href="javascript:;" id="kt_login_forgot" class="text-black font-weight-bold">&#160;Forget Password ?</a>
 -->								</div>
	...
	<script type="text/javascript"
		src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/plugins/global/plugins.bundle.js"></script>
	<script type="text/javascript"
		src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
	<script type="text/javascript"
		src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/js/scripts.bundle.js"></script>
	...
	<script type="text/javascript"
		src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/js/pages/custom/login/login-general.js"></script>
		<script type="text/javascript">
