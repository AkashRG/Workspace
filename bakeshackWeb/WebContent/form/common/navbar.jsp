		...
		<div class="d-flex align-items-stretch mr-3">
			...
			<div class="header-logo">
				<a href="index.jsp"> <img alt="Logo"
					src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/Bake-Shack-Logo.png"
						...
						<li class="menu-item menu-item-submenu menu-item-rel"
							...
							<div class="menu-submenu menu-submenu-classic menu-submenu-left">
								<ul class="menu-subnav">
									...
									<li class="menu-item" aria-haspopup="true"><a
										href="in_out_laser.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
										</i> <span class="menu-text">IN-OUT Laser</span>
									</a></li>
		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="topbar-item" data-toggle="dropdown"
					...
					<div
						...
						<span class="svg-icon svg-icon-xl"> <!--begin::Svg Icon | path:assets/media/svg/icons/Media/Equalizer.svg-->
							<svg xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
								height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none"
				...
				<div
					...
					<form>
						...
						<div
							class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top"
							style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack013.jpg)">
							<span class="btn btn-md btn-icon bg-white-o-15 mr-4"> <i
								class="flaticon2-shopping-cart-1 text-success"></i>
							</span>
			...
			<div class="dropdown">
				...
				<div class="topbar-item" data-toggle="dropdown"
					...
					<div
						class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
						<span class="svg-icon svg-icon-xl"> <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Cart3.svg-->
							<svg xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
								height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none"
				...
				<div
					...
					<form>
						...
						<div
							class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top"
							style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack014.jpg)">
							<span class="btn btn-md btn-icon bg-white-o-15 mr-4"> <i
								class="flaticon2-shopping-cart-1 text-success"></i>
							</span>
			...
			<div class="dropdown">
				...
				<div class="topbar-item">
					<div
						...
						<span
							class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">RANJIT</span>
						<span class="symbol symbol-35"> <span
							class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">RK</span>
						</span>
					</div>
				</div>
				<!--end::Toggle-->
			...
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5">
					<div class="symbol-label"
						style="background-image:url('<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/Bake-Shack-Logo.png')"></div>
...
<script
	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ref_file/plugins.bundle.js"></script>
<script
	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ref_file/prismjs.bundle.js"></script>
<script
	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ref_file/scripts.bundle.js"></script>


<script
	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ref_file/fullcalendar.bundle.js"></script>


<script
	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ref_file/widgets.js"></script>
...
/* 	
	 ...
	 */
	 $('.navbar_customer_data').on('click','.customer_name01',function(){
			//$(this).closest('tr').val();	
			//var query = $(this).closest('td').val();
			// var cust = $("#customer_count-"+customer_count+"").val();
			
			
			  var currentRow = $(this).closest("tr");
			  var col1 = currentRow.find(".customer_name01").html();
			 alert("query-"+col1);
			});
	...
	$.ajax({
		...
		success:function(data)
		{
			...
			data.forEach((row)=> {
				vendors_count++;
				 ...
				 html2 += "<td onClick='myFunction()'>"+row.vendors_name+"</td>"; 
	 ...
	 $('#vendors_count-'+vendors_count).dblclick(function(){
		  var id = $(this).attr('id');
		 alert(id);
		})
	var html1 = "";
