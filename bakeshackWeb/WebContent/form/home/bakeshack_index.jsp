...
<body id="kt_body" style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack003.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
									...
									<div class="col-xl-8">
										<div class="row">
											<div class="col-xl-3">
												...
												<div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg)">
													<!--begin::Body-->
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg)">
													<!--begin::Body-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg')"></div>
									...
									<div class="d-flex flex-column mb-5 align-items-start">
										<div class="d-flex align-items-center">
											<div class="symbol symbol-circle symbol-40 mr-3">
												<img alt="Pic" src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg" />
											</div>
											<div>
