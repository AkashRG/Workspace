...
//user Master
	...
	public JSONArray getUsersDetails() {
		...
		JSONArray jarr = null;
		JSONObject finaljson = null;
		String users_id = "", login_id = "", password = "", users_name = "", birth_date = "", role_type = "",
				address = "", city_desc = "", district_desc = "", gender = "", mobile_no = "", email_id = "",
				gov_id = "";
		try {
			jarr = new JSONArray();
			...
			while (rs.next()) {
				...
				users_name = rs.getString(4);
				birth_date = rs.getString(5);
				role_type = rs.getString(6);
				address = rs.getString(7);
				city_desc = rs.getString(8);
				district_desc = rs.getString(9);
				gender = rs.getString(10);
				mobile_no = rs.getString(11);
				email_id = rs.getString(12);
				gov_id = rs.getString(13);
...
//customer master
	...
	public int insertUpdateSalesAndOrderDetails(int customer_code, String delivery_address, String order_date,
			...
			String balance_amount, String received_bank, String account_no, String transaction_code, int invoice_code,
		...
		try {
			...
			cs.setInt(19, sales_and_order_id);
			cs.setInt(20, flag);
	...
	public int insertUpdatePurchaseDetails(int vendors_code, String delivery_address, String order_date,
			String delivery_date, String order_code, String product_list, String amount, String discount,
			String payment_mode, String upi_name, String total_amount, String partial_paid_amount,
			String balance_amount, String given_bank, String account_no,String delivery_charges, int invoice_code, int purchase_id, int flag) {
	...
	public JSONArray getCustomerWiseReportDetails(String customer_name, String from_date, String till_date) {
		...
		try {
			...
			while (rs.next()) {
				...
				resultjson.put("customer_name", rs.getString(1));
				resultjson.put("odrer_date", rs.getString(2));
				resultjson.put("invoice_code", rs.getString(3));
...
//In Out Laser
	...
	public int insertUpdateOrderBookingDetails(int customer_code, String delivery_address, String order_date,
			...
			String cancelation_date, int status, int order_id, int flag) {
	...
	public int insertUpdateSalesAndOrderDetailsFromDelivery(int customer_code, String delivery_address,
			...
			String balance_amount, String received_bank, String account_no, String transaction_code,
			String invoice_code,String advance_paid, String delivery_charges ,int sales_and_order_id, int flag) {
		...
		try {
			...
			cs.setInt(21, sales_and_order_id);
			cs.setInt(22, flag);
