										...
										<div class="card-header border-0 pt-5">
											<div class="card-title">
												<div class="card-label">
													...
													<div class="font-size-sm text-muted mt-2">890,344
														Sales</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-xl-12" style="height: 440px;">
											...
											<div
												...
												<%--  style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack012.jpg)" --%>  >
<style>
...
<div class="mySlides fade">
  ...
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack001.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade"> 
  <div class="numbertext">2 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack002.jpg" style="width:100%;height:100%" >
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack003.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack004.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">5 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">6 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack006.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">7 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack007.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">8 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack008.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">9 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack009.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">10 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack010.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">11 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack011.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">12 / 12</div>
  <img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack012.jpg" style="width:100%;height:100%">
  <div class="text"></div>
</div>
</div>
...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
					...
					<div class="mb-15">
						...
						<div class="d-flex align-items-center flex-wrap mb-5">
							<div class="symbol symbol-50 symbol-light mr-5">
								<span class="symbol-label"> <!-- 	<img src="assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" /> -->
								</span>
							</div>
						...
						<div class="d-flex align-items-center flex-wrap mb-5">
							<div class="symbol symbol-50 symbol-light mr-5">
								<span class="symbol-label"> <!-- <img src="assets/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt="" /> -->
								</span>
							</div>
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#"
						...
						<div class="d-flex align-items-center flex-wrap mb-5">
							<div class="symbol symbol-50 symbol-light mr-5">
								<span class="symbol-label"> <!-- 	<img src="assets/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt="" /> -->
								</span>
							</div>
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#"
						...
						<div class="d-flex align-items-center flex-wrap mb-5">
							<div class="symbol symbol-50 symbol-light mr-5">
								<span class="symbol-label"> <!-- <img src="assets/media/svg/misc/005-bebo.svg" class="h-50 align-self-center" alt="" /> -->
								</span>
							</div>
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#"
						...
						<div class="d-flex align-items-center flex-wrap">
							<div class="symbol symbol-50 symbol-light mr-5">
								<span class="symbol-label"> <!-- 	<img src="assets/media/svg/misc/014-kickstarter.svg" class="h-50 align-self-center" alt="" /> -->
								</span>
							</div>
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#"
								...
								<div class="d-flex flex-column mb-5 align-items-start">
									<div class="d-flex align-items-center">
										<div class="symbol symbol-circle symbol-40 mr-3">
											<img alt="Pic"
												src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/BakeShack005.jpg" />
										</div>
										<div>
											<a href="#"
	...
	<script
		src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/js/pages/features/charts/amcharts/charts.js"></script>
	<script>
