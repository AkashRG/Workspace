								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/temp_chart.pdf" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/bp_sugar_chart.pdf" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
