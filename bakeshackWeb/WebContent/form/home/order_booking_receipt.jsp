				...
				<div class="content d-flex flex-column flex-column-fluid"
						...
						<div class="container " style="font-size: 16px;">
							...
							<div class="card card-custom overflow-hidden">
								<div class="card_body p-0" id="ab"
									...
									<%-- <div class="card-body p-0" style=" background-image:url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/bslh.png); height:1547px; width:100%;"> --%>
									<%-- <img alt="Logo"
					src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/Footer1.png"
					class="logo-default max-h-100% max-w-100% ml-18" style=" top:0;" /> --%>
									...
									<div class="col-md-10" style="position: relative;  ">
  											<img src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/stampsign.png" class="offset-1" id="sign" >
					...
					<img alt="Logo"
						src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/gif/Footer.png"
