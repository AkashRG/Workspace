...
public class ConnectDataBean {
	...
	public int insertUpdatePatientDetails(String patient_name, Date birth_date, String patient_code, String mobile_no,
			String city_desc, String blood_group, Date registration_date, int patient_id, int flag) {
		Connection con = null;
		CallableStatement cs = null;
		ResultSet rs = null;
		...
		try {
			...
			cs.setDate(8, registration_date);
			cs.setInt(9, flag);
			cs.setInt(10, patient_id);
...
//report Details
	...
	public int insertUpdateInvoiceDetails( int patient_code,int visit_id, String inv_date, 
			...
			String paid_fee, String paid_date,String balance_amt, String transaction_id,int invoice_id, int flag) {
